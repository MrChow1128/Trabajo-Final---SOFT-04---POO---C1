...
public class DAOOrden {
    ...
    public static String insertarOrden(Orden orden) throws SQLException, ClassNotFoundException, IOException {
    ...
    public static ArrayList<Orden> listarOrdenes() throws SQLException, ClassNotFoundException, IOException {
