...
public class DAOOferta {
    ...
    public static String insertarOferta(int idSubasta, Oferta oferta) throws SQLException, ClassNotFoundException, IOException {
    ...
    public static ArrayList<Oferta> listarOfertasPorSubasta(int idSubasta) throws SQLException, ClassNotFoundException, IOException {
