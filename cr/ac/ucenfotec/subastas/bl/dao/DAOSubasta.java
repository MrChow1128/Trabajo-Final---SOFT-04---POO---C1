...
public class DAOSubasta {
    ...
    public static String insertarSubasta(Subasta subasta) throws SQLException, ClassNotFoundException, IOException {
    ...
    public static ArrayList<Subasta> listarSubastas() throws SQLException, ClassNotFoundException, IOException {
    ...
    public static Subasta seleccionarSubastaPorId(int idBuscado) throws SQLException, ClassNotFoundException, IOException {
    ...
    public static void cerrarSubasta(int idSubasta) throws SQLException, ClassNotFoundException, IOException {
        statement = "UPDATE t_subastas SET activa = ? WHERE id = ?";
        Connector.getConexion().ejecutarStatement(statement, false, idSubasta);
    }

    public static int obtenerUltimoIdSubasta() throws SQLException, ClassNotFoundException, IOException {
