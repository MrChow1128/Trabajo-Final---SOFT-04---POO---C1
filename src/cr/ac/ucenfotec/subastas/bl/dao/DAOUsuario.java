...
public class DAOUsuario {
    ...
    public static String insertarUsuario(Usuario usuario) throws SQLException, ClassNotFoundException {
    ...
    public static Usuario seleccionarUsuarioPorCredenciales(String identificacion, String contrasena) throws SQLException, ClassNotFoundException {
    ...
    public static Usuario seleccionarUsuarioPorIdentificacion(String identificacion) throws SQLException, ClassNotFoundException {
    ...
    public static boolean existeIdentificacion(String identificacion) throws SQLException, ClassNotFoundException {
        query = "SELECT identificacion FROM t_usuarios WHERE identificacion = ?";
        ResultSet resultado = Connector.getConexion().ejecutarQuery(query, identificacion);
        return resultado.next();
    }

    public static boolean existeCorreo(String correo) throws SQLException, ClassNotFoundException {
