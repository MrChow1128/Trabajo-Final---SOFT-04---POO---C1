...
public class DAOObjeto {
    ...
    public static void insertarObjeto(int idSubasta, Objeto objeto) throws SQLException, ClassNotFoundException {
    ...
    public static ArrayList<Objeto> seleccionarObjetosPorSubasta(int idSubasta) throws SQLException, ClassNotFoundException {
